...
public class csGit {
	...
	@ResponseBody
//	@RequestMapping(value="/ceshi",produces = {"text/plain;charset=utf-8","text/html;charset=utf-8"}) ·ÀÖ¹ @ResponseBodyÂÒÂë
	...
	public Map<String ,Person> test1(){
		...
		map.put("a", person);
		map.put("b", person);//{"a":{"id":"8a7f937e65e711ea933668f728ada465","name":"Ð¡Ã÷","grade":"60","sex":"1"},"b":{"id":"8a7f937e65e711ea933668f728ada465","name":"Ð¡Ã÷","grade":"60","sex":"1"}}
		try {
